...
> **Correction appended 2026-09-11 (original left intact above, per this file's rule).** Two of the three elements of that LTA sentence are verbatim T1; the third is not supported by any retrievable company document. The 2Q26 earnings presentation, page 10, in both English and Korean, says: *"Concluded around 10 LTA negotiations including key customers"* and *"Financial mechanisms(e.g. deposits) incorporated to support contract fulfillment"* — so **"~10 customers" and "deposits" are confirmed.** **"Typically five-year terms" appears nowhere** — not on the slide, not in either language of the press release, not in the Semi-Annual Business Report, in either Korean or English. The Korean press release says only 다년 계약, *multi-year*. Classify the five-year figure as **unverifiable rather than disproven**: SK hynix publishes no Q2 transcript (the IR script PDF 404s and its link is hidden with `display:none`; only archived audio exists, which we cannot transcribe), so it may have been said on the call. But it must not be carried forward as fact, and it was almost certainly a paraphrase that hardened into a number in this file.
>
> **The substantive finding cuts the other way, and it is stronger than the original entry implies.** The LTAs are **neither price-committed nor volume-committed**, on T1 evidence. In the Semi-Annual Business Report filed **2026-08-14** — sixteen days *after* the call — the company **newly appended** a clause to its Order Status schedule: 장기공급계약에 따른 수주 현황은 없습니다, *"there is no order status arising from long-term supply contracts."* That clause exists in neither the FY2025 report (2026-03-17) nor the Q1 report (2026-05-15). It matters because FSS 「기업공시서식 작성기준」 Art. 4-2-7 expressly brings **장기매출계약 (long-term sales contracts) within scope** and demands order total and backlog in both quantity and value — so a framework with no committed quantity and no committed price yields no backlog. The company also did not invoke the trade-secret carve-out, which the same rule bars once the content has been made public. Pricing is described only as "designed to address price volatility" and "varying by customer" — no index, floor, collar or formula anywhere. Management has never used the word *binding*.
>
> **The deposits are not visible at any material scale.** At 2026-06-30, contract liabilities of KRW 523,532M plus advance receipts of KRW 49,582M total KRW 573,114M. Against Q2 revenue of KRW 79,318,746M that is 573,114 ÷ 79,318,746 = **0.72% of a single quarter**, or about **0.66 days** of revenue at KRW 871,634M/day. The balance *fell* 5.3% from KRW 605,202M at 2026-03-31 in a quarter when revenue rose 51%, and it was **larger** two years ago (KRW 543,477M at 2024-12-31), so it is not an LTA line. There are no non-current contract liabilities and no refund-liability line. Point-in-time revenue was 99.955% of the total. Honest caveat: these predate the 2026-07-29 announcement, so LTA deposits would first appear in the **Q3 2026 report, due ~2026-11-16 `(est.)`** — the first Order Status schedule with a reference date after the LTAs were signed, and the print that closes this question either way.
>
> **Lesson (for the retro, and it is about this file, not about SK hynix).** A number with no as-of date and no tier marker entered the ledger's own "detail worth carrying forward" and survived a quarter, then got copied into a research brief as a premise. The rule that every number carries an as-of date has to apply to *this file* too, and the LTA sentence carried none.
